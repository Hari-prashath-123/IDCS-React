...
export default function PrincipalStudentProfile() {
  const { id } = useParams();
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
          <div>
            ...
            <p className="text-slate-600">View student details (read-only)</p>
          </div>
          <div>
            <button
              onClick={() => navigate('/principal/student-details')}
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="inline-block text-xs px-2 py-1 rounded bg-blue-100 text-blue-700 capitalize mb-2">student</div>
