...
interface EventForm {
  ...
  status: 'pending' | 'hod_approved' | 'hod_rejected' | 'iqac_approved' | 'iqac_rejected' | 'principal_approved' | 'principal_rejected';
  hod_remarks?: string;
  iqac_remarks?: string;
...
export default function EventParticipationApproval() {
  ...
  const fetchForms = async () => {
    ...
    try {
      ...
      // Fetch forms from staff in the same department
  ...
  const confirmAction = async () => {
    ...
    try {
      ...
      const updateData: any = {
        status: actionType === 'approve' ? 'hod_approved' : 'hod_rejected',
  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-slate-800">Event Participation Approvals</h1>
          <p className="text-sm text-slate-600 mt-1">Review and approve event participation forms from your department</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
            ...
            <p className="text-slate-600">No event participation forms to review at this time.</p>
          </div>
        ) : (
