...
async function main() {
  ...
  try {
    ...
    console.error('Failed to reach admin API:', e?.message || e);
    process.exit(1);
  }

  const toTest = rows.slice(0, 2);
  console.log(`Importing first ${toTest.length} rows to ${ADMIN_API_URL}/create-student`);
